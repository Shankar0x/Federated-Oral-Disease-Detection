...
class FederatedClient(object):
    ...
    def __init__(self, server_host, server_port, task_config_filename,
        ...
        self.sio = SocketIO(server_host, server_port, None, {'timeout': 36000},cors_allowed_origins="*")
        #self.sio = SocketIO(server_host, server_port, engineio_logger=True, logger=True, ping_timeout=36000, ping_interval=36000, protocol_version=4)
