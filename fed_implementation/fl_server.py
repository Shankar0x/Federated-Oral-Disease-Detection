...
class FLServer(object):
    def __init__(self, task_config_filename, host, port):
        ...
        self.socketio = SocketIO(self.app, ping_timeout=3600000,ping_interval=3600000,max_http_buffer_size=int(1e32),cors_allowed_origins="*")
        #self.socketio = SocketIO(self.app, ping_timeout=3600000,ping_interval=3600000,max_http_buffer_size=int(1e32),cors_allowed_origins="*",socket_io_path="/socket.io/v4")
